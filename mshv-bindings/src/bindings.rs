...
pub const hv_x64_register_name_HV_X64_REGISTER_GHCB: hv_x64_register_name = 589849;
...
pub const hv_x64_register_name_HV_X64_REGISTER_SEV_GHCB_GPA: hv_x64_register_name = 589889;
pub const hv_x64_register_name_HV_X64_REGISTER_SEV_DOORBELL_GPA: hv_x64_register_name = 589890;
...
fn bindgen_test_layout_hv_partition_property_page_access_tracking_config() {
    const UNINIT: ::std::mem::MaybeUninit<hv_partition_property_page_access_tracking_config> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
